  ...
  return (
   <div id="Mainpage-1" className="Mainpage-1">
    ...
    <div className="content-page-1">
      <button className="night-mode-button" id="night-mode-button" onClick={nightmode}><img className="night-mode" src="src/assets/night-with-stars-svgrepo-com.svg"></img></button>
